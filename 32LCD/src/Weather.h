...
//
/////////////////////////////////////////
PROGMEM const uint8_t City[3][52] =
    {{0x80, 0x00, 0xBE, 0x02, 0x80, 0x04, 0x80, 0x00, 0xFF, 0x07, 0x88, 0x00, 0x88, 0x00, 0xBA, 0x00,
      0x0A, 0x01, 0x0A, 0x05, 0x3A, 0x06, 0x07, 0x04, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0xFA, 0x03,
      0x10, 0x02, 0x10, 0x02, 0x11, 0x02, 0x12, 0x01, 0x20, 0x01, 0xA0, 0x00, 0x44, 0x00, 0xA2, 0x00,
      0x11, 0x01, 0x0C, 0x06},
     {0x44, 0x00, 0x34, 0x07, 0x54, 0x05, 0x5F, 0x05, 0x54, 0x05, 0x56, 0x05, 0x5E, 0x05, 0x75, 0x05,
      0x54, 0x07, 0x44, 0x01, 0x24, 0x01, 0x14, 0x01, 0x00, 0x00, 0x00, 0x00, 0x08, 0x04, 0x48, 0x04,
      0x48, 0x04, 0x4A, 0x04, 0x5A, 0x05, 0x69, 0x06, 0x48, 0x04, 0x48, 0x04, 0x44, 0x04, 0x44, 0x04,
      0x42, 0x04, 0x01, 0x04},
     {0x20, 0x00, 0xFE, 0x03, 0x22, 0x02, 0xFE, 0x03, 0x20, 0x00, 0xFF, 0x07, 0x00, 0x00, 0xFE, 0x03,
      0x22, 0x02, 0x22, 0x02, 0xD8, 0x01, 0x07, 0x06, 0x00, 0x00, 0x00, 0x00, 0x10, 0x01, 0x11, 0x01,
      0xFA, 0x03, 0x10, 0x01, 0xFC, 0x07, 0x11, 0x01, 0x0A, 0x02, 0xF4, 0x05, 0x10, 0x01, 0xF4, 0x01,
      0x12, 0x02, 0xE1, 0x03}};
/////////////////////////////////////////
...
void weather();
void weadisplay(int);
void weaicons(int, int);
void WeatherNow(int);
void WeatherDaily(int);
/////////////////////////////////////////
#endif
/*
struct Weather
